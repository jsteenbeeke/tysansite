...
@Component
public class SenateElectionOneRemainingAndActivePopulator implements IEntityPopulator {
	public static final String KEY = "start-senate-election-when-one-active-and-one-senator-remaining";
	@Autowired
