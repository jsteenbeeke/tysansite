...
public class TruthsayerStepDownPage extends AbstractMemberPage {
	private static final long serialVersionUID = 1L;

	public TruthsayerStepDownPage() {
		super("Step down");
		...
		add(new IconLink.Builder("images/icons/tick.png",
				new DefaultClickResponder<User>(ModelMaker.wrap(getUser())) {
					...
					@Override
					public void onClick() {
						democracyService.stepDownAsTruthsayer(getUser());

						setResponsePage(new OverviewPage());
					}
				}).setText("Yes, I want to stop being a Truthsayer")
				.newInstance("yes"));
