 ...
 */
public class ChancellorElectionChecker extends HyperionTask {
	public ChancellorElectionChecker() {
		super("Chancellor election", TysanTaskGroup.DEMOCRACY);
	...
	public void run(ServiceProvider provider) {
		...
		provider.getService(DemocracyService.class).checkChancellorElections();
	}
