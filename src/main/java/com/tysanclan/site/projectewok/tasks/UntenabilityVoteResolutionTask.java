 ...
 */
public class UntenabilityVoteResolutionTask extends HyperionTask {
	public UntenabilityVoteResolutionTask() {
		super("Untenability Vote Resolution", TysanTaskGroup.DEMOCRACY);
	}

	@Override
	public void run(ServiceProvider provider) {
		provider.getService(DemocracyService.class).resolveUntenabilityVotes();
	}
