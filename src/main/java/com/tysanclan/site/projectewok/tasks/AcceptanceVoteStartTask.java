 ...
 */
public class AcceptanceVoteStartTask extends HyperionTask {
	public AcceptanceVoteStartTask() {
		super("Acceptance vote start", TysanTaskGroup.MEMBERS);
	}

	@Override
	public void run(ServiceProvider provider) {
		provider.getService(DemocracyService.class).checkAcceptanceVotes();
