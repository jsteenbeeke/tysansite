 ...
 */
public class AcceptanceVoteStopTask extends HyperionTask {
	public AcceptanceVoteStopTask() {
		super("Acceptance vote stop", TysanTaskGroup.MEMBERS);
	}

	@Override
	public void run(ServiceProvider provider) {
		provider.getService(DemocracyService.class).resolveAcceptanceVotes();
