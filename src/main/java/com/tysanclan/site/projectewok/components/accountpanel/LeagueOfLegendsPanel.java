...
public class LeagueOfLegendsPanel extends Panel {
	...
	public LeagueOfLegendsPanel(String id, UserGameRealm userGameRealm) {
		...
		Form<UserGameRealm> form = new Form<UserGameRealm>("addLoLForm",
			...
			protected void onSubmit() {
				...
				GameAccount acc = gameService.createLeagueOfLegendsAccount(ugr,
		...
		setVisible(gameService.isValidAccountType(userGameRealm.getGame(),
				userGameRealm.getRealm(), AccountType.LEAGUE_OF_LEGENDS));
