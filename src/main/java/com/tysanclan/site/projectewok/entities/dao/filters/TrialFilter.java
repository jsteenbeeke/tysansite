 ...
 */
public class TrialFilter extends SearchFilter<Trial> {
	...
	private boolean withTrialThread = true;
	 ...
	 *            the user to set
	 */
	public void setAccused(User user) {
	...
	public boolean isWithTrialThread() {
		return withTrialThread;
	}

	public void setWithTrialThread(boolean withTrialThread) {
		this.withTrialThread = withTrialThread;
	}
